        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden flex-grow">
                ...
                <div className="max-w-7xl mx-auto px-4 relative">
                    ...
                    >
                        <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center glow">
                    ...
                    {isLoading ? (
                        ...
                        >
                            ...
                            <h3 className="font-display text-2xl font-bold mb-2">No Upcoming Registrations</h3>
